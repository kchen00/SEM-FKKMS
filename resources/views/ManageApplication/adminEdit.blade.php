...
@section('content')
    ...
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form role="form" method="POST" action={{route('application.adminUpdate', $application['application_ID'])}} enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="file" name="SSM" value="{{ old('SSM', $application['SSM']) }}">
                                    </div>
                                </div>
                                <div class="form-group">
