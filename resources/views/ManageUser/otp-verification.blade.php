                    ...
                    <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                        <div class="card card-plain">
                            <div class="card-header pb-0 text-start">
                                ...
                                <p class="mb-0">Please enter the OTP sent to your mobile number.</p>
                            </div>
                            <div class="card-body">
                                <form role="form" method="POST" action="{{ route('otp.verify.perform') }}">
                                    @csrf
                                    <div class="flex flex-col mb-3">
                                        <label for="otp">OTP:</label>
                                        <input type="text" name="otp" class="form-control form-control-lg" placeholder="OTP" aria-label="OTP" required>
                                        @error('otp') <p class="text-danger text-xs pt-1"> {{$message}} </p>@enderror
                                    </div>
